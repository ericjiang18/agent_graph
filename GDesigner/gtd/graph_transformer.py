...
class GraphTransformer(nn.Module):
    ...
    """
    def __init__(self, node_feature_dim, condition_dim, time_embed_dim, num_layers, num_heads, output_dim, dropout_rate=0.1):
    ...
    def forward(self, node_features, adj_matrix, task_condition, time_embedding):
        ...
        Args:
            ...
            task_condition (torch.Tensor): Task and agent team context embedding (batch_size, condition_dim).
        ...
        """
        # Project time embedding and concatenate with task_condition
        projected_time_embedding = self.time_projection(time_embedding)
        combined_condition = torch.cat((task_condition, projected_time_embedding), dim=1)
